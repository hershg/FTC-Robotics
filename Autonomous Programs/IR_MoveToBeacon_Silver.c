...
task main ()
{
  ...
  /*for(int i=0; i<5; i++) {  // max 5 attempts to align direction

  	turnToBeacon(); // try align to the beacon for 4 sec (HW timer is inside the function

  	if (dirAC!=4) { // in case we are not aligned then move to different posn and try again
