...
int DetectIRBeacon()
{
  ...
  int dirAC_2 = 0;
	...
	// display info
	nxtDisplayCenteredTextLine(2, "P=%d,D1=%d,D2=%d", WhichPeg,dirAC_1,dirAC_2);
...
task main ()
{
  ...
  waitForStart(); // Wait for the beginning of autonomous phase.
	...
	else if(WhichPeg == 2)
	{
		...
		Move(-60, 60, SPIN(46), SPIN(46));
		Move(100, 100, 1300, 1300);
		Move(60, 60, 1000, 1000);
		RaiseSlideLift(-100, 5000);
		StartTask(LowerArm);
